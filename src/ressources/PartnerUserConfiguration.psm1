class PartnerUserConfiguration 
{
    ...
    static [PartnerUserConfiguration] $instance

    static [PartnerUserConfiguration] GetInstance(){
        if ([PartnerUserConfiguration]::instance -eq $null)
        {
            [PartnerUserConfiguration]::instance = [PartnerUserConfiguration]::new()
        }

        return [PartnerUserConfiguration]::instance
    }
